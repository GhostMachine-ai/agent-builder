...
Not vendored: `skill/scripts/` (live browser-mode machinery), subagent definitions,
Puppeteer-based URL scanning, all other harness-specific compiled trees.

## Updating

1. Clone the upstream repo at the desired tag/commit.
2. Re-copy the paths in the table above (delete this tree first, keep `package.json` and this file).
